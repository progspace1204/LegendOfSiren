...
export default class Bootstrap extends Phaser.Scene {
  ...
  loadHub() {
    ...
    this.load.image('battle-background', 'assets/background/bg.png')
    ...
    this.load.image('enemy-bar', 'assets/images/enemy-bar.png')
    this.load.image('enemy-bar-frame', 'assets/images/enemy-bar-frame.png')
    this.load.image('siren-bar', 'assets/images/enemy-bar.png')
    this.load.image('heart-mark', 'assets/images/heart-mark.png')
    this.load.image('embed-bar', 'assets/images/embed-bar.png')
    this.load.image('siren-bar-frame', 'assets/images/enemy-bar-frame.png')
  ...
  loadInventory() {
    ...
    this.load.image('inventory-btn', 'assets/images/inventory-btn.png')
    this.load.image('play-pve', 'assets/images/play-pve.png')
    this.load.image('play-pvp', 'assets/images/play-pvp.png')
    this.load.image('close-btn', 'assets/images/close.svg')
